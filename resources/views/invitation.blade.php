...
<div id="content" class="content-hidden">
    ...
    <footer class="invitation-footer">
        <div class="footer-inner">
            ...
            <p class="footer-brand">by <span class="footer-brand-name">undangin</span></p>

            <div class="footer-socials">
                <a href="#" target="_blank" rel="noopener noreferrer" class="footer-social-link" aria-label="WhatsApp">
            ...
            <p class="footer-copyright">&copy; 2025 undangin. All rights reserved.</p>
        </div>
    </footer>
